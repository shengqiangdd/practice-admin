    ...
    private QueryWrapper insCondition(TCarRunEntity tCarRun, Map<String, Object> params) {
        ...
        if (params != null) {
            ...
            if (begintime != null && endtime != null) {
                ...
                queryWrapper.apply("tcr.begintime between to_date({0},'yyyy-MM-dd')", begintime);
                queryWrapper.apply("to_date({0},'yyyy-MM-dd')", endtime);
            }
            ...
            if (!StringUtils.isEmpty(treeMonth)) {
                ...
                queryWrapper.apply("tcr.begintime between to_date({0},'yyyy-MM-dd')", treeMonth);
                queryWrapper.apply("to_date({0},'yyyy-MM-dd')", d + day);
