...
@Data
@TableName("t_car_run")
@KeySequence(value = "T_CAR_RUN_SEQ",clazz = Integer.class)
public class TCarRunEntity implements Serializable {
	 ...
	 * 主键
	 */
	@TableId(value = "\"if\"",type = IdType.INPUT)
	private Integer id;
	/**
	 * 车号
	 */
	 ...
	 * 开始时间
	 */
	@TableField(jdbcType = JdbcType.DATE,update = "to_date(#{et.begintime},'yyyy-mm-dd hh24:mi:ss')")
	private String begintime;
	/**
	 * 预计回车时间
	 */
	@TableField(jdbcType = JdbcType.DATE,update = "to_date(#{et.planreturntime},'yyyy-mm-dd hh24:mi:ss')")
