    ...
    private QueryWrapper insCondition(TCarCarEntity tCarCar, Map<String, Object> params) {
        ...
        if (car.isPresent()) {
            ...
            if (!StringUtils.isEmpty(tCarCar.getModel())) {
                queryWrapper.eq("tcc.mode]", tCarCar.getModel());
            }
        ...
        if (params != null) {
            ...
            if (buydate1 != null && buydate2 != null) {
                ...
                queryWrapper.apply("tcc.buydate between to_date({0},'yyyy-MM-dd')",buydate1);
                queryWrapper.apply("to_date({0},'yyyy-MM-dd')",buydate2);
            }
